 ...
 * @author Andrés
 */
public class Panel_normal_1 extends javax.swing.JFrame {
    ...
    public Panel_normal_1() {
        ...
        btn3.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                Panel_normal_2 paneln2 = new Panel_normal_2();
    ...
    public class PanelBackground extends JPanel { //Se deja aca en View debido a su simplicidad
        ...
        protected void paintComponent(Graphics g) {
            ...
            if (image == null) {
                image = new ImageIcon(getClass().getResource("/images/final 2 p1 text.png")).getImage();
            }
