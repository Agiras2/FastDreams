 ...
 * @author Andrés
 */
public class Panel_normal_5 extends javax.swing.JFrame {
    ...
    public Panel_normal_5() {
        ...
        btn2.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                Panel_normal_4 paneln4 = new Panel_normal_4();
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (image == null) {
            image = new ImageIcon(getClass().getResource("/images/final 2 p5 text.png")).getImage();
        }
